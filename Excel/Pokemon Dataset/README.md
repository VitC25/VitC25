...
## Showcased Skills
1. Transforming Data:
- Using Power Query Tool in Excel to Clean and shape the data to fit with values that were null/blank and spelled correctly.
- Allowing thorough used of filtering to be user efficiently.
2. Charts & Tables:
- Created Pivot Tables that directly effect the data shown on the respective charts, allowing the user to switch which stats can be shown. 
