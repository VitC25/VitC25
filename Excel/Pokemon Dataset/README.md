...
2. Charts & Tables - Created Pivot Tables that directly effect the data shown on the respective charts, allowing the user to switch which stats can be shown.
3. 
